...
// BlockNote content type - generic to support both web (BlockNote) and mobile alternatives
// In web: this is NotebookContent from @blocknote/core
// In mobile: this could be a different format
...
export interface NotebookPage {
  ...
  userId: string
  title: string
  content: NotebookContent // BlockNote content
  order: number
  createdAt: string
  updatedAt: string
}
